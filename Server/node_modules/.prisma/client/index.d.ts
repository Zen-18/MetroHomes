...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'user' | 'residency' | 'lawyer' | 'loan'
    ...
    model: {
      ...
      Lawyer: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.LawyerFindRawArgs<ExtArgs>,
            result: Prisma.JsonObject
          }
          aggregateRaw: {
            args: Prisma.LawyerAggregateRawArgs<ExtArgs>,
            result: Prisma.JsonObject
          }
          count: {
  ...
  export interface LawyerDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
    ...
    /**
     * Find zero or more Lawyers that matches the filter.
     * @param {LawyerFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const lawyer = await prisma.lawyer.findRaw({
     *   filter: { age: { $gt: 25 } } 
     * })
    **/
    findRaw(
      args?: LawyerFindRawArgs
    ): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Lawyer.
     * @param {LawyerAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const lawyer = await prisma.lawyer.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
  ...
  interface LawyerFieldRefs {
    ...
    readonly firm: FieldRef<"Lawyer", 'String'>
    readonly location: FieldRef<"Lawyer", 'String'>
    readonly image: FieldRef<"Lawyer", 'String'>
    readonly email: FieldRef<"Lawyer", 'String'>
    readonly phoneNumber: FieldRef<"Lawyer", 'String'>
    readonly qualification: FieldRef<"Lawyer", 'String'>
    readonly experience: FieldRef<"Lawyer", 'String'>
   ...
   * Lawyer findRaw
   */
  export type LawyerFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
   ...
   * Lawyer aggregateRaw
   */
  export type LawyerAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  interface LoanFieldRefs {
    ...
    readonly bank: FieldRef<"Loan", 'String'>
    readonly description: FieldRef<"Loan", 'String'>
    readonly image: FieldRef<"Loan", 'String'>
    readonly interestRate: FieldRef<"Loan", 'Float'>
    readonly Address: FieldRef<"Loan", 'String'>
    readonly terms: FieldRef<"Loan", 'String'>
    readonly documents: FieldRef<"Loan", 'String'>
    readonly contactInfo: FieldRef<"Loan", 'String'>
    readonly email: FieldRef<"Loan", 'String'>
  ...
  export type UserWhereInput = {
    ...
    emailToken?: StringFilter<"User"> | string
  }
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    emailToken?: StringWithAggregatesFilter<"User"> | string
  }
  ...
  export type LawyerWhereInput = {
    ...
    firm?: StringFilter<"Lawyer"> | string
    location?: StringFilter<"Lawyer"> | string
    image?: StringNullableFilter<"Lawyer"> | string | null
    email?: StringFilter<"Lawyer"> | string
    phoneNumber?: StringFilter<"Lawyer"> | string
    qualification?: StringFilter<"Lawyer"> | string
    experience?: StringFilter<"Lawyer"> | string
  ...
  export type LawyerScalarWhereWithAggregatesInput = {
    ...
    firm?: StringWithAggregatesFilter<"Lawyer"> | string
    location?: StringWithAggregatesFilter<"Lawyer"> | string
    image?: StringNullableWithAggregatesFilter<"Lawyer"> | string | null
    email?: StringWithAggregatesFilter<"Lawyer"> | string
    phoneNumber?: StringWithAggregatesFilter<"Lawyer"> | string
    qualification?: StringWithAggregatesFilter<"Lawyer"> | string
    experience?: StringWithAggregatesFilter<"Lawyer"> | string
  ...
  export type LoanWhereInput = {
    ...
    bank?: StringNullableFilter<"Loan"> | string | null
    description?: StringFilter<"Loan"> | string
    image?: StringNullableFilter<"Loan"> | string | null
    interestRate?: FloatFilter<"Loan"> | number
    Address?: StringNullableFilter<"Loan"> | string | null
    terms?: StringFilter<"Loan"> | string
    documents?: StringFilter<"Loan"> | string
    contactInfo?: StringFilter<"Loan"> | string
    email?: StringFilter<"Loan"> | string
  ...
  export type LoanScalarWhereWithAggregatesInput = {
    ...
    bank?: StringNullableWithAggregatesFilter<"Loan"> | string | null
    description?: StringWithAggregatesFilter<"Loan"> | string
    image?: StringNullableWithAggregatesFilter<"Loan"> | string | null
    interestRate?: FloatWithAggregatesFilter<"Loan"> | number
    Address?: StringNullableWithAggregatesFilter<"Loan"> | string | null
    terms?: StringWithAggregatesFilter<"Loan"> | string
    documents?: StringWithAggregatesFilter<"Loan"> | string
    contactInfo?: StringWithAggregatesFilter<"Loan"> | string
    email?: StringWithAggregatesFilter<"Loan"> | string
